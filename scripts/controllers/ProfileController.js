...
(function() {
	...
	app.controller('ProfileController', function($location, validate, profile_data, $scope, $http, $log, $window) {
		...
		$scope.update_profile = function() {
			...
			$http.post('/api/user/profile', $scope.formData)
		...
		return {
			...
			link: function(scope, elem, attrs, ngModel) {
				...
				const validate = function() {
					// values
					const dirty1 = scope.profile.confirm_password.$dirty;
					const dirty2 = scope.profile.new_password.$dirty;
